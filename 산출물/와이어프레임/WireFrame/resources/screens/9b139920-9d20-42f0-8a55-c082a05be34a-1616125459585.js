jQuery("#simulation")
  .on("click", ".s-9b139920-9d20-42f0-8a55-c082a05be34a .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Rectangle_24")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("mouseenter dragenter", ".s-9b139920-9d20-42f0-8a55-c082a05be34a .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
    if(jFirer.is("#s-Rectangle_34") && jFirer.has(event.relatedTarget).length === 0) {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Rectangle_41") && jFirer.has(event.relatedTarget).length === 0) {
      event.backupState = true;
      event.target = jFirer;
      cases = [
        {
  ...
  .on("mouseleave dragleave", ".s-9b139920-9d20-42f0-8a55-c082a05be34a .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
