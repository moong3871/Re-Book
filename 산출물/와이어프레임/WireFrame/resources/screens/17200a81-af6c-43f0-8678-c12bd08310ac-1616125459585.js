jQuery("#simulation")
  .on("click", ".s-17200a81-af6c-43f0-8678-c12bd08310ac .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-17200a81-af6c-43f0-8678-c12bd08310ac .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-17200a81-af6c-43f0-8678-c12bd08310ac .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
