...
<script>
import korea from "@/assets/bookdata/genre2/한국소설.json";
import japan from "@/assets/bookdata/genre2/일본소설.json";
import usa from "@/assets/bookdata/genre2/영미소설.json";
export default {
  data: () => ({
    model: null,
    category_set: [],
  ...
  created() {
    this.category_set.push(korea);
    this.category_set.push(japan);
    this.category_set.push(usa);
