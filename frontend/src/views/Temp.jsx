...
const InfoMap = (props) => {
  ...
  function getLikePlaces() {
    dispatch(getLikeFeeds(email)).then((res) => {
  ...
  return (
    <>
            ...
            <Typography variant="h6" className={classes.title}>
              ...
              {toggleBtn ? (
                <div className="like_wrap_Btn">
                  <button className="like_btn" onClick={displayLikeMarkers}>
                ...
                <div className="all_wrap_Btn">
                  <button className="all_btn" onClick={displayAllMarkers}>
                    <img
                      className="img_acorn"
                      src={mapMarker}
                      alt="mapMarker"
      ...
      <div className="infomap">
        {toggleBtn ? null : (
          <button className="likeListBtn" onClick={goLikeList}>
            좋아요 목록
          </button>
        )}
